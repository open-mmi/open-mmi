...
Later slices may add channels, readiness checks, a restricted update coordinator, health validation, and rollback. Those capabilities remain blocked until their security and failure semantics are implemented and tested.
...
3. Stable/beta/development channel policy.
...
- adds no install, rollback, channel-change, scheduling, or unattended-update action.
